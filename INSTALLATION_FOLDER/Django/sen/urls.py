...
urlpatterns = patterns('',
    ...
    url(r'^ppage/','sen.usrper.views.ppage'),
    url(r'^upage/','sen.usrper.views.upage'),
    url(r'^changepassword/','sen.usrper.views.change_password'),
    url(r'^signup/','sen.usrper.views.spage'),
    url(r'^putindatabase/','sen.usrper.views.signuppage'),
    url(r'^groups/', 'sen.groups.views.show_grp'),
    url(r'^getmem/(?P<gid>\d+)/', 'sen.groups.views.get_members'),   # 	HORIBBLE OUTPUT
