...
# make month lists contain list of days for each week
    ...
    return render_to_response("cal/view_month.html", dict(year = year, month = month, user = request.user, month_days = lst, month_name = month_names[month-1], reminders = reminders(request)))
